  ...
  return (
    <div className="fixed bottom-5 right-4 z-50 flex flex-col items-end gap-3 sm:bottom-6 sm:right-6">
      ...
      <a
        ...
        aria-label="Call"
        className="flex h-12 w-12 items-center justify-center rounded-full bg-maroon-600 text-white shadow-card transition-all duration-300 hover:scale-110 hover:bg-maroon-700 sm:h-13 sm:w-13"
      >
