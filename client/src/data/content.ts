...
export const faqs = [
  ...
  {
    question: 'संगम ज्योतिष संस्थान का मुख्य केंद्र कहाँ स्थित है और क्या व्यक्तिगत रूप से मिलकर परामर्श लिया जा सकता है?',
    answer:
      'संगम ज्योतिष संस्थान का पावन केंद्र प्रयागराज के कोरांव (212306) में बेलन नदी के तट पर स्थित शोभनाथ मंदिर (Sobhnath Temple / Shobhnath Mandir) परिसर में स्थित है। आप पूर्व समय निर्धारित करके व्यक्तिगत रूप से उपस्थित होकर भी परामर्श प्राप्त कर सकते हैं। इसके अतिरिक्त देश-विदेश के जातकों के लिए ऑनलाइन व WhatsApp परामर्श सुविधा भी निरंतर उपलब्ध है।',
  },
];
