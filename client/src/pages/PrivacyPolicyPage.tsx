  ...
  return (
    <div className="bg-cream-50">
      <SEO
        ...
        description="संगम ज्योतिष संस्थान की गोपनीयता नीति — आपकी जन्म कुंडली, जन्म विवरण, व्यक्तिगत जानकारी एवं परामर्श की पूर्ण सुरक्षा व गोपनीयता।"
        canonical="/privacy-policy"
        keywords={[
          'गोपनीयता नीति',
          'Privacy Policy Sangam Jyotish',
          'Kundli Data Privacy',
        ]}
        schema={{
          '@context': 'https://schema.org',
          '@type': 'WebPage',
          name: 'गोपनीयता नीति (Privacy Policy)',
          url: 'https://sangamjyotish.com/privacy-policy',
        }}
      />
      {/* Header */}
