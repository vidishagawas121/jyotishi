...
export function AppointmentPage() {
  return (
    <div className="bg-cream-50">
      <SEO
        title="ज्योतिष परामर्श अपॉइंटमेंट बुक करें | ऑनलाइन एवं फोन परामर्श"
        description="संगम ज्योतिष संस्थान में ऑनलाइन व फोन पर व्यक्तिगत वैदिक ज्योतिष परामर्श के लिए सरल फॉर्म भरकर तुरंत अपॉइंटमेंट बुक करें।"
        canonical="/appointment"
        keywords={[
          'ज्योतिष अपॉइंटमेंट बुक करें',
          'ऑनलाइन ज्योतिष परामर्श बुकिंग',
          'WhatsApp ज्योतिष परामर्श',
          'कुंडली परामर्श समय निर्धारण',
          'Book Vedic Astrology Appointment',
          'Online Jyotish Consultation Booking',
          'Schedule Kundli Reading Session',
        ]}
        schema={{
          '@context': 'https://schema.org',
          '@type': 'WebPage',
          name: 'ज्योतिष परामर्श अपॉइंटमेंट बुक करें',
          description: 'वैदिक ज्योतिष आधारित व्यक्तिगत और गोपनीय परामर्श सत्र हेतु अपॉइंटमेंट बुकिंग।',
          url: 'https://sangamjyotish.com/appointment',
          potentialAction: {
            '@type': 'ReserveAction',
            target: 'https://sangamjyotish.com/appointment',
            result: {
              '@type': 'Reservation',
              name: 'Astrology Consultation Appointment',
            },
          },
        }}
      />
