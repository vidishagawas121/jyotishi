  ...
  return (
    <div className="bg-cream-50">
      <SEO
        ...
        description="संगम ज्योतिष संस्थान के अनुभवी एवं विद्वान ज्योतिषाचार्यों से मिलें - आचार्य सूर्यदेव जी, आचार्य हरिओम जी, आचार्य अरुण पंडित एवं माता रेणुका जी से व्यक्तिगत ज्योतिष परामर्श प्राप्त करें।"
        ...
        keywords={[
          ...
          'आचार्य हरिओम जी',
          'आचार्य अरुण पंडित',
          'माता रेणुका जी ज्योतिषी',
          'Best Vedic Astrologers India',
          'Certified Astrologer Consultation',
          'Top Jyotish Acharyas Online',
        ]}
        schema={{
          '@context': 'https://schema.org',
          '@type': 'ProfilePage',
          name: 'हमारे ज्योतिषाचार्य - संगम ज्योतिष संस्थान',
          url: 'https://sangamjyotish.com/astrologers',
          mainEntity: {
            '@type': 'ItemList',
            itemListElement: astrologers.map((ast, idx) => ({
              '@type': 'Person',
              position: idx + 1,
              name: ast.name,
              jobTitle: ast.designation,
              description: ast.biography,
              knowsAbout: ast.specializations,
            })),
          },
        }}
      />
