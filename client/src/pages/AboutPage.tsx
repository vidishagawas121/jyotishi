  ...
  return (
    <div className="bg-cream-50">
      <SEO
        ...
        description="संगम ज्योतिष संस्थान की वैदिक ज्योतिष परंपरा, प्रामाणिक दृष्टिकोण, अनुभव, गुरुकुल विरासत और समाज सेवा के संकल्प के बारे में जानें।"
        canonical="/about"
        keywords={[
          'संगम ज्योतिष संस्थान परिचय',
          'वैदिक ज्योतिष परंपरा',
          'प्रामाणिक ज्योतिषाचार्य भारत',
          'ज्योतिष संस्थान इतिहास',
          'About Sangam Jyotish Sansthan',
          'Vedic Astrology Heritage India',
          'Authentic Jyotish Scholars',
          'Vedic Kundli Center',
        ]}
        schema={{
          '@context': 'https://schema.org',
          '@type': 'AboutPage',
          name: 'हमारे बारे में - संगम ज्योतिष संस्थान',
          description: 'संगम ज्योतिष संस्थान की वैदिक ज्योतिष परंपरा, प्रामाणिक दृष्टिकोण और गुरुकुल विरासत।',
          url: 'https://sangamjyotish.com/about',
          mainEntity: {
            '@type': 'Organization',
