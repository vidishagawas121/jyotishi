  ...
  return (
    <div className="bg-cream-50">
      <SEO
        ...
        description="विवाह, कुंडली मिलान, प्रेम व संबंध, करियर, व्यापार, वित्त, वास्तु, ग्रह शांति, संतान सुख, शुभ मुहूर्त एवं रत्न परामर्श सहित 12 प्रमुख वैदिक ज्योतिष सेवाएं।"
        canonical="/services"
        keywords={[
          'वैदिक ज्योतिष सेवाएं',
          'कुंडली मिलान सेवा',
          'करियर ज्योतिष परामर्श',
          'व्यापार ज्योतिष सेवाएं',
          'वास्तु परामर्श सेवाएं',
          'ग्रह शांति पूजा बुकिंग',
          'रत्न परामर्श सेवा',
          'मुहूर्त निर्धारण सेवा',
          'Vedic Astrology Services India',
          'Online Horoscope Reading Services',
          'Astrology Consultation Packages',
        ]}
        schema={{
          '@context': 'https://schema.org',
          '@type': 'CollectionPage',
          name: 'ज्योतिष सेवाएं - संगम ज्योतिष संस्थान',
          description: 'संगम ज्योतिष संस्थान द्वारा प्रदान की जाने वाली प्रामाणिक वैदिक ज्योतिष सेवाएं।',
          url: 'https://sangamjyotish.com/services',
          mainEntity: {
            '@type': 'ItemList',
            itemListElement: services.map((s, idx) => ({
              ...
              url: `https://sangamjyotish.com/services/${s.slug}`,
            })),
          },
        }}
      />
